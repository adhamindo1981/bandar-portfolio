          ...
          <div className="space-y-6">
            ...
            <div className="pt-4 border-t border-white/5 space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <a href="#" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-blue-600 transition-all hover:-translate-y-1">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="#" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-yellow-400 hover:text-black transition-all hover:-translate-y-1">
                ...
                <a href="#" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-green-400 hover:text-black transition-all hover:-translate-y-1">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M13.511 5.833L17.9 1.444l1.389 1.389-4.389 4.389h4.389v1.944H13.511V11.222h1.944v4.389h-1.944V24H10.489V15.611H8.545V11.222h1.944V9.167H4.711V7.222H9.1L4.711 2.833l1.389-1.389 4.389 4.389V0h1.944v5.833z"/></svg>
                </a>
              </div>
            </div>
          </div>
